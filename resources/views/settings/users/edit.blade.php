        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('settings.users.update', $user->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">Leave blank to keep current password. Password must be at least 8 characters long.</small>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                @if($user->avatar)
                                                <img src="{{ $user->avatar }}" alt="{{ $user->name }}" class="rounded-circle me-3" width="64" height="64">
                                                @else
                                        ...
                                        <div class="mb-3 mt-4">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="activeUser" name="active_user" {{ $user->email_verified_at ? 'checked' : '' }}>
                                                <label class="form-check-label" for="activeUser">Active Account</label>
                                            </div>
                                            <small class="text-muted">Deactivating a user prevents them from logging in.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                <div class="card bg-light">
                                                    <div class="card-body py-3">
                                                        <h6 class="card-title mb-0">Account Created</h6>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="card bg-light">
                                                    <div class="card-body py-3">
                                                        <h6 class="card-title mb-0">Last Modified</h6>
                                                        <p class="card-text">{{ $user->updated_at->format('M d, Y') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="card bg-light">
                                                    <div class="card-body py-3">
                                                        <h6 class="card-title mb-0">Email Verified</h6>
                                                        <p class="card-text">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="card bg-light">
                                                    <div class="card-body py-3">
                                                        <h6 class="card-title mb-0">Last Login</h6>
                                                        <p class="card-text">
                                                            {{ $user->last_login_at ? $user->last_login_at->format('M d, Y H:i') : 'Never' }}
                                                        </p>
                                                        @if($user->last_login_device)
                                                        <small class="text-muted">
                                                            <i class="bi bi-laptop"></i> {{ $user->last_login_device }}
                                                        </small>
                                                        @endif
                                                    </div>
                                                </div>
